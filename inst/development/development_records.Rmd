...
template <- read_sequence("../extdata/puc19.fasta")
target <- read_sequence("../extdata/GFP sequence.fasta")
```
...
template <- read_sequence("../extdata/puc19.fasta", input_type = 'template')
target <- read_sequence("../extdata/GFP sequence.fasta", input_type = 'target')
```
...
inputs <- read_sequences_noclass(target, input_type = 'target')
inputs <- read_sequences_noclass(template, input_df = inputs, input_type = 'template')
