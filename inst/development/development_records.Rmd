...
test_list <- list(threeprime_end_seq, input_seqs_test)
lapply(test_list, function(x) parse_inputs(x))


```

### Exploring thermodynamics of the interaction between mega-primer and template
...
Our test dataset is the mega-primer to insert the GFP gene into the pUC19 plasmid
at position 1500. 
